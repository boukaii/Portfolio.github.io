    ...
    <div id="nav-footer">
      ...
      <div className='global-footer'>
        <div className='link-footer'>
            ...
            <p>Développeur Web front & back-end,
            <br />
        ...
        <div className="link-footer">
          <h3 className='contact'>Coordonnées</h3>   
            <p><a><FaEnvelope className='icons'/> guillaume27121993@gmail.com</a></p>
        ...
        <div className="link-footer">
          ...
          <div className="social-icons">
            <a className='lien-icons' href="https://www.linkedin.com/in/votrenom" target="_blank" rel="noopener noreferrer">
              <FaLinkedin className='icons1'/>
            </a>
            <a className='lien-icons' href="https://github.com/votrenom" target="_blank" rel="noopener noreferrer">
